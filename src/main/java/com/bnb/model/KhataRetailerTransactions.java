...
/**
 * KhataRetailerTransactions generated by hbm2java
 */
@Entity
@Table(name = "khata_retailer_transactions", schema = "public")
public class KhataRetailerTransactions implements java.io.Serializable {
	...
	public KhataRetailerTransactions() {
	}

	public KhataRetailerTransactions(long id, int retailerId, double amount, int txnType, int paymentType,
	...
	public KhataRetailerTransactions(long id, int retailerId, Integer khataCustomerId, double amount, int txnType,
